...
import { PomodoroSessionDTO, PomodoroCycleDTO } from './pomodoro.dto';
...
export class PomodoroController {
  ...
  @UsePipes(new ValidationPipe())
	...
	@Put('/cycle/:id')
	@Auth()
	async updateCycle(@Param('id') id: string, @Body() dto: PomodoroCycleDTO) {
		return this.pomodoroService.updateCycle(dto, id)
	}
